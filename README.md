 Eye Tracking Mouse
A simple cursor controller designed for use with dragonfly/caster. Requires a consumer grade Tobii eye tracking device.

This project requires the Tobii Stream Engine which can be downloaded [here](https://developer.tobii.com/consumer-eye-trackers/stream-engine/getting-started/).

## Features
- Cursor snapping to gaze point
  - Auto snapping to controls (using Windows Automation)
- Cursor snapping to grid
  - Visual guide
  - Customizable through voice controls
- Head tracking cursor control
- Eye scrolling (vertical and horizontal)
- Multiple monitor support
- Tobii eye tracker recalibration functions

## Roadmap
- OCR 
- Improved auto snapping with computer vision

## Usage

Run the application and see the sample files for communicating with dragonfly/caster.

Here is an example caster grammar:
